...
class AppStrings {
  ...
  // ── App ──────────────────────────────────────
  String get appName           => isZh ? '赫尔墨斯'            : 'SutaAgent';
  String get appSubtitle       => isZh ? 'Android AI 网关'     : 'AI Gateway for Android';
  String get appNameLong        => isZh ? '赫尔墨斯 Android'    : 'SutaAgent';
  ...
  String get reinstallingHermes     => isZh ? '正在重新安装 Hermes...'  : 'Reinstalling SutaAgent...';
  ...
  String get hermesAgentLabel       => isZh ? 'SutaAgent'        : 'SutaAgent';
  ...
  // ── Setup Wizard ─────────────────────────────
  String get setupHermesAgent       => isZh ? '安装赫尔墨斯'         : 'Setup SutaAgent';
  String get setupProgressDesc      => isZh ? '首次安装约需 10-30 分钟，请保持网络畅通...'
                                         : 'First setup takes ~10-30 min. Keep network on.';
  String get setupInitialDesc       => isZh ? '将下载 Ubuntu、Python 和 SutaAgent 到独立环境中'
                                         : 'This will download Ubuntu, Python, and SutaAgent into a self-contained environment.';
  ...
  String get installHermesAgent     => isZh ? '安装 SutaAgent'    : 'Install SutaAgent';
  ...
  String get cloningHermesRepo      => isZh ? '正在克隆 SutaAgent 仓库...': 'Cloning SutaAgent repository...';
  String get installingPyDeps       => isZh ? '正在安装 Python 依赖...': 'Installing Python dependencies...';
  String get verifyingInstall       => isZh ? '正在验证 SutaAgent 安装...': 'Verifying SutaAgent installation...';
  String get hermesAgentInstalled   => isZh ? 'SutaAgent 安装完成': 'SutaAgent installed';
  ...
  String get onboardingAppBar       => isZh ? '引导设置'             : 'SutaAgent Onboarding';
  String get configureAppBar        => isZh ? '网关配置'             : 'SutaAgent Configure';
  ...
  String get stepInstallingHermes   => isZh ? '安装 SutaAgent'    : 'Installing SutaAgent';
